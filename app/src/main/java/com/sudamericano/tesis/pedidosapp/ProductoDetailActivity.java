...
/**
 * An activity representing a single Producto detail screen. This
 * activity is only used narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link ProductoListActivity}.
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ProductoDetailFragment.ARG_ITEM_ID,
              ...
              arguments.putSerializable(ProductoDetailFragment.ARG_ITEM_PRODUCT,
                    getIntent().getSerializableExtra(ProductoDetailFragment.ARG_ITEM_PRODUCT));
